fileFolder=fullfile('D:\DL\essay\code\数据集\datasets\TNO\train\ir'); % Folder where infrared images or visible images are located
...
ir_dir = 'D:\DL\essay\code\数据集\datasets\TNO\train\ir'; % Folder where infrared images are located
vi_dir = 'D:\DL\essay\code\数据集\datasets\TNO\train\vis'; % Folder where visible images are located

outout_dir = 'D:\DL\essay\code\数据集\datasets\TNO\train\mask_vi'; % Folder where fused images are located
if ~exist(outout_dir, 'dir')
    mkdir(outout_dir);
end
for k = 1:num
